...
HD_PWD='C:/Users/ethan/Desktop/Circuits/Vivado/Lab5_RR/Lab5_RR.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log Lab5_RR_top.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source Lab5_RR_top.tcl -notrace
