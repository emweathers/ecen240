...
HD_PWD='C:/Users/ethan/Desktop/Circuits/Vivado/Lab5_RR/Lab5_RR.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log Lab5_RR_top.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source Lab5_RR_top.tcl
